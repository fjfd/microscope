 ...
 */
public class RestEasyWebServer implements Runnable {

	private static final String LOG_PATH = "./target/logs/access/yyyy_mm_dd.request.log";

	private static final String WEB_XML = "WEB-INF/resteasy.xml";
	...
	public static void main(String[] args) throws Exception {
		...
		new RestEasyWebServer(port).start();
	}
	...
	public RestEasyWebServer(int aPort) {
		this(aPort, null);
	}

	public RestEasyWebServer(int aPort, String aBindInterface) {
		port = aPort;
