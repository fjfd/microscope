...
public class TracerTest {
    ...
    public void testOSP() throws InterruptedException {
        // mainTask clientSend
        Tracer.clientSend("MainTask", SpanCategory.Method);
    ...
    static class TaskB implements Runnable {
        ...
        public void run() {
            Tracer.clientSend(traceId, spanId, "TaskB_" + step, SpanCategory.Method);
    ...
    static class TaskA implements Runnable {
        ...
        public void run() {
            ...
            Tracer.clientSend(traceId, spanId, "TaskA_" + step, SpanCategory.Method);
