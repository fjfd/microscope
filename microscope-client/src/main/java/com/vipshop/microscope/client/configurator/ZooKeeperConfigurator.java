 ...
 * @version 1.0
 */
public class ZooKeeperConfigurator extends AbstractConfigurator implements Configurator {

    private static final Logger logger = LoggerFactory.getLogger(ZooKeeperConfigurator.class);

    @Override
    public void setConfig(ConfigurationUtil properties) {
        configurationUtil = properties;

        // TODO write data to zookeeper and watch when data changed!
    }
