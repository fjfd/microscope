...
public enum SpanCategory {
    ...
    public static int getIntValue(Span span) {
        ...
        return SpanCategory.valueOf(category).intValue();
    }

    public static int getIntValue(String type) {
        return SpanCategory.valueOf(type).intValue();
    }

    public static String getStringValue(int value) {
        SpanCategory[] categories = SpanCategory.values();
        for (SpanCategory categorie : categories) {
    ...
    public static boolean hasProblem(Span span) {
        ...
        return SpanCategory.valueOf(category).hasProblem(time);
    }

    public static int getTimeZone(Span span) {
        String category = span.getSpanType();
        int time = span.getDuration();
        return SpanCategory.valueOf(category).getTimeZone(time);
    }
