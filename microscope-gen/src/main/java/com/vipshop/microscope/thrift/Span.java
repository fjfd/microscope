...
public class Span implements org.apache.thrift.TBase<Span, Span._Fields>, java.io.Serializable, Cloneable {
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		TRACE_ID((short) 1, "trace_id"), NAME((short) 3, "name"), ID((short) 4, "id"), PARENT_ID((short) 5, "parent_id"), ANNOTATIONS((short) 6, "annotations"), DEBUG((short) 7, "debug"), APP_NAME(
				(short) 8, "app_name"), ORDER((short) 9, "order"), DURATION((short) 10, "duration"), STARTSTAMP((short) 11, "startstamp"), TYPE((short) 12, "type");
	...
	public Span(long trace_id, String name, long id, List<Annotation> annotations, String app_name, int order, int duration, long startstamp, String type) {
		this();
