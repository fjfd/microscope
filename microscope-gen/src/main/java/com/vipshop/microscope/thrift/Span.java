...
public class Span implements org.apache.thrift.TBase<Span, Span._Fields>, java.io.Serializable, Cloneable {
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TYPE((short)12, "type"),
    RESULT_CODE((short)13, "resultCode"),
    IPADDRESS((short)14, "IPAddress"),
    CONTENT_SIZE((short)15, "contentSize");
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULT_CODE, new org.apache.thrift.meta_data.FieldMetaData("resultCode", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.IPADDRESS, new org.apache.thrift.meta_data.FieldMetaData("IPAddress", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public Span setIPAddress(String IPAddress) {
  ...
  public Span setContentSize(int contentSize) {
    this.contentSize = contentSize;
    setContentSizeIsSet(true);
    return this;
  }
  ...
  public void unsetContentSize() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __CONTENTSIZE_ISSET_ID);
  }

  /** Returns true if field contentSize is set (has been assigned a value) and false otherwise */
  public boolean isSetContentSize() {
    return EncodingUtils.testBit(__isset_bitfield, __CONTENTSIZE_ISSET_ID);
  }

  public void setContentSizeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __CONTENTSIZE_ISSET_ID, value);
  }
  ...
  public boolean equals(Span that) {
    ...
    boolean this_present_contentSize = true;
    boolean that_present_contentSize = true;
    if (this_present_contentSize || that_present_contentSize) {
      if (!(this_present_contentSize && that_present_contentSize))
        return false;
  ...
  public int compareTo(Span other) {
    ...
    lastComparison = Boolean.valueOf(isSetContentSize()).compareTo(typedOther.isSetContentSize());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetContentSize()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.contentSize, typedOther.contentSize);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
        ...
        switch (schemeField.id) {
          ...
          case 15: // CONTENT_SIZE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              ...
              struct.setContentSizeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Span struct) throws org.apache.thrift.TException {
      ...
      if (struct.annotations != null) {
        oprot.writeFieldBegin(ANNOTATIONS_FIELD_DESC);
        {
          ...
          for (Annotation _iter13 : struct.annotations)
          {
            _iter13.write(oprot);
          }
          oprot.writeListEnd();
      ...
      oprot.writeFieldBegin(CONTENT_SIZE_FIELD_DESC);
