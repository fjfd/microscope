...
public final class OneToThreeSequencedThroughputTest extends AbstractPerfTestDisruptor {
    ...
    public OneToThreeSequencedThroughputTest(ProducerType type, WaitStrategy strategy) {
        ...
        handlers = new ValueMutationEventHandler[NUM_EVENT_PROCESSORS];
        ...
        batchEventProcessors = new BatchEventProcessor[NUM_EVENT_PROCESSORS];
    ...
    public static void main(String[] args) throws Exception {
        ...
        OneToThreeSequencedThroughputTest test1 = new OneToThreeSequencedThroughputTest(ProducerType.SINGLE, new YieldingWaitStrategy());
        test1.testImplementations();

        System.out.println("ProducerType.SINGLE, use sleep wait strategy");
        OneToThreeSequencedThroughputTest test2 = new OneToThreeSequencedThroughputTest(ProducerType.SINGLE, new SleepingWaitStrategy());
        test2.testImplementations();

        System.out.println("ProducerType.SINGLE, use block wait strategy");
        OneToThreeSequencedThroughputTest test3 = new OneToThreeSequencedThroughputTest(ProducerType.SINGLE, new BlockingWaitStrategy());
        test3.testImplementations();

        System.out.println("ProducerType.SINGLE, use busy spin wait strategy");
        OneToThreeSequencedThroughputTest test4 = new OneToThreeSequencedThroughputTest(ProducerType.SINGLE, new BusySpinWaitStrategy());
        test4.testImplementations();

        System.out.println("ProducerType.MULTI, use yield wait strategy");
        OneToThreeSequencedThroughputTest test5 = new OneToThreeSequencedThroughputTest(ProducerType.MULTI, new YieldingWaitStrategy());
        test5.testImplementations();

        System.out.println("ProducerType.MULTI, use sleep wait strategy");
        OneToThreeSequencedThroughputTest test6 = new OneToThreeSequencedThroughputTest(ProducerType.MULTI, new SleepingWaitStrategy());
        test6.testImplementations();

        System.out.println("ProducerType.MULTI, use block wait strategy");
        OneToThreeSequencedThroughputTest test7 = new OneToThreeSequencedThroughputTest(ProducerType.MULTI, new BlockingWaitStrategy());
        test7.testImplementations();

        System.out.println("ProducerType.MULTI, use busy spin wait strategy");
        OneToThreeSequencedThroughputTest test8 = new OneToThreeSequencedThroughputTest(ProducerType.MULTI, new BusySpinWaitStrategy());
