...
import com.vipshop.microscope.mysql.repository.MsgStatRepository;
...
public class TraceMessageCounter {
	...
	private final MsgStatRepository msgStatRepository = MySQLRepositorys.MSG_STAT_REPOSITORY;
