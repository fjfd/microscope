...
public class MesssageStats {
    ...
    public static void stats(LogEntry logEntry) {
         ...
         */
        long currentKey = getKey(calendarUtil);
    ...
    public static void stats(String log){
    ...
    public static void storeLogEntryReport(LogEntryReport report) {
