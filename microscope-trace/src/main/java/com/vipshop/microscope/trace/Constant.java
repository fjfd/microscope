...
public class Constant {
	...
	private static final Configuration config = Configuration.getConfiguration("trace-config.properties");
	...
	public static final int MAX_EMPTY_SIZE = config.getInt("max_empty_siez");
