 ...
 * <p/>
 * {@code http://opentsdb.net/docs/build/html/api_http/index.html#version-1-x-to-2-x}
 *
...
public class OpenTsdb {
    ...
    public static void main(String[] args) throws InterruptedException {
        OpenTsdb tsdb = OpenTsdb.forService("http://127.0.0.1:9411")
                .create();
        ...
        OpenTsdbMetric metric = OpenTsdbMetric.named("opentsdb.test.metric")
