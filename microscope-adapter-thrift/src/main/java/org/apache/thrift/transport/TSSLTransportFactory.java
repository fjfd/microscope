...
/**
 * A Factory for providing and setting up Client and Server SSL wrapped TSocket
 * and TServerSocket
 */
public class TSSLTransportFactory {
	 ...
	 * configuration the default settings are used. Default settings are
	 * retrieved from System properties that are set.
	 * 
	 * Example system properties: -Djavax.net.ssl.trustStore=<truststore
	 * location> -Djavax.net.ssl.trustStorePassword=password
	...
	/**
	 * Get a default SSL wrapped TServerSocket bound to the specified port and
	 * interface
	 * 
	 * @param port
	 * @param clientTimeout
	...
	/**
	 * Get a configured SSL wrapped TServerSocket bound to the specified port
	 * and interface. Here the TSSLTransportParameters are used to set the
	...
	private static TServerSocket createServer(SSLServerSocketFactory factory, int port, int timeout, boolean clientAuth, InetAddress ifAddress, TSSLTransportParameters params)
			throws TTransportException {
		try {
	...
	/**
	 * Get a default SSL wrapped TSocket connected to the specified host and
	 * port. All the client methods return a bound connection. So there is no
	 * need to call open() on the TTransport.
	 * 
	 * @param host
	 * @param port
	 * @param timeout
	...
	/**
	 * Get a custom configured SSL wrapped TSocket. The SSL settings are
	 * obtained from the passed in TSSLTransportParameters.
	 * 
	 * @param host
	 * @param port
	 * @param timeout
	...
	public static class TSSLTransportParameters {
		 ...
		 * 
		 * @param protocol
		 *            The specific protocol (TLS/SSL) can be specified with
		 *            versions
		 * @param cipherSuites
		 */
		...
		/**
		 * Create parameters specifying the protocol, cipher suites and if
