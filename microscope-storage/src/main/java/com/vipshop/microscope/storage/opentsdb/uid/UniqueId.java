...
public final class UniqueId implements UniqueIdInterface {
	 ...
	 *             if width is negative or too small/large or if kind is an
	 *             empty string.
	 */
	 ...
	 *             if there was a problem getting suggestions from HBase.
	 */
	 ...
	 * 
	 * @param oldname
	 *            The old name to rename.
	 * @param newname
	 *            The new name.
	 * @throws NoSuchUniqueName
	 *             if {@code oldname} wasn't assigned.
	 * @throws IllegalArgumentException
	 *             if {@code newname} was already assigned.
	 * @throws HBaseException
	 *             if there was a problem with HBase while trying to update the
	 *             mapping.
	 */
