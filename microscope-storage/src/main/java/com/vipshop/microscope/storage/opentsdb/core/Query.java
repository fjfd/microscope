...
public interface Query {
     ...
     * @throws IllegalStateException if {@link #setStartTime} was never called on this instance
     *                               before.
     */
    long getStartTime();
     ...
     * @throws IllegalArgumentException if timestamp is less than or equal to 0, or if it can't fit
     *                                  on 32 bits.
     * @throws IllegalArgumentException if {@code timestamp >= }{@link #getEndTime getEndTime}.
     */
     ...
     * @throws IllegalArgumentException if timestamp is less than or equal to 0, or if it can't fit
     *                                  on 32 bits.
     * @throws IllegalArgumentException if {@code timestamp <= }{@link #getStartTime getStartTime}.
     */
     ...
     *                 actual values.
     * @throws NoSuchUniqueName if the name of a metric, or a tag name/value does not exist.
     */
     ...
     * idea is similar. Instead of returning every single data point that
     ...
     * that interval together using an {@link Aggregator}. This enables you to
     * compute things like the 5-minute average or 10 minute 99th percentile.
     *
     ...
     * returned corresponds to one time series for which some data
     * points have been matched by the query.
