...
public interface WritableDataPoints extends DataPoints {
     ...
     *                                  timestamp added or 0 for the first timestamp, or if the
     *                                  difference with the previous timestamp is too large.
     * @throws IllegalArgumentException if the value is {@code NaN} or {@code Infinite}.
     * @throws HBaseException           (deferred) if there was a problem while persisting data.
     */
     ...
     * before being sent to HBase. {@code 0} (the default) means data points are
     ...
     *             points should be buffered before being sent to HBase. This
     *             deadline will be honored on a "best effort" basis.
     */
     ...
     * <li>{@link #setBufferingTime} may be called with an argument chosen by
