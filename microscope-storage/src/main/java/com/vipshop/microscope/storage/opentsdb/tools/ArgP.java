...
public final class ArgP {
	 ...
	 * 
	 * @param name
	 *            The name of the option to recognize (e.g. {@code --foo}).
	 * @param meta
	 *            The meta-variable to associate with the value of the option.
	 * @param help
	 ...
	 * @throws IllegalArgumentException
	 *             if any of the given strings is empty.
	 */
	public void addOption(final String name, final String meta,
			final String help) {
		if (name.isEmpty()) {
			throw new IllegalArgumentException("empty name");
		} else if (name.charAt(0) != '-') {
			throw new IllegalArgumentException("name must start with a `-': "
					+ name);
	 ...
	 * <p>
	 * Calling {@link #addOption(String, String, String) addOption}
	 * {@code (foo, ...)} entails that {@code optionExists(foo)} returns
	 * {@code true}.
	 * 
	 * @param name
	 *            The name of the option to recognize (e.g. {@code --foo}).
	 ...
	 *         with a dash).
	 * @throws IllegalArgumentException
	 *             if the given command line wasn't valid.
	 */
	 ...
	 *            The name of the option to recognize (e.g. {@code --foo}).
	 * @throws IllegalArgumentException
	 *             if this option wasn't registered with {@link #addOption}.
	 * @throws IllegalStateException
	 *             if {@link #parse} wasn't called.
	 */
	...
	public String toString() {
		...
		for (final String name : options.keySet()) {
			final String[] opt = options.get(name);
			buf.append(name).append("=(").append(opt[0]).append(", ")
					.append(opt[1]).append(')').append(", ");
		}
