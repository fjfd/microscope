...
public abstract class StatsCollector {
	 ...
	 * 
	 * @param prefix
	 *            A prefix to add to every metric name, for example `tsd'.
	 */
	 ...
	 * 
	 * @param datapoint
	 *            A data point in a format suitable for a text import.
	 */
	 ...
	 *            The current value for that metric.
	 * @param xtratag
	 *            An extra tag ({@code name=value}) to add to those data points
	 *            (ignored if {@code null}).
	 * @throws IllegalArgumentException
	 *             if {@code xtratag != null} and it doesn't follow the
	 ...
	 *            The name of the metric.
	 * @param histo
	 *            The histogram to collect data points from.
	 * @param xtratag
	 *            An extra tag ({@code name=value}) to add to those data points
	 *            (ignored if {@code null}).
	 * @throws IllegalArgumentException
	 ...
	 *            The current value for that metric.
	 * @param xtratag
	 *            An extra tag ({@code name=value}) to add to this data point
	 *            (ignored if {@code null}).
	 * @throws IllegalArgumentException
	 *             if {@code xtratag != null} and it doesn't follow the
	 *             {@code name=value} format.
	 ...
	 * @throws IllegalArgumentException
	 *             if the name or the value are empty or otherwise invalid.
	 * @see #clearExtraTag
	 */
	 ...
	 * 
	 * @param name
	 *            The name of the tag to remove from the set of extra tags.
	 * @throws IllegalStateException
	 *             if there's no extra tag currently recorded.
	 * @throws IllegalArgumentException
	 *             if the given name isn't in the set of extra tags currently
	 *             recorded.
	 * @see #addExtraTag
	 */
