...
public final class Tags {
     ...
     * @throws NoSuchUniqueName if one of the elements in the map contained an unknown tag
     *                          name or tag value.
     */
     ...
     * @throws NoSuchUniqueId           if one of the elements in the array contained an invalid ID.
     * @throws IllegalArgumentException if one of the elements in the array had the wrong number of
     *                                  bytes.
     */
