...
import com.vipshop.microscope.storage.opentsdb.core.Tags;
import com.vipshop.microscope.storage.opentsdb.core.WritableDataPoints;
...
final class TextImporter {
    ...
    private static final Logger LOG = LoggerFactory
            .getLogger(TextImporter.class);
    private static final HashMap<String, WritableDataPoints> datapoints = new HashMap<String, WritableDataPoints>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            LOG.info(String.format("Total: imported %d data points in %.3fs"
                            + " (%.1f points/s)", points, time_delta,
                    (points / time_delta)
            ));
            // TODO(tsuna): Figure out something better than just writing to
            // stderr.
    ...
    private static int importFile(final HBaseClient client, final TSDB tsdb,
        ...
        try {
            final class Errback implements Callback<Object, Exception> {
                public Object call(final Exception arg) {
                    ...
                    LOG.error("Exception caught while processing file " + path,
                            arg);
                    System.exit(2);
                    return arg;
                }
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (points % 1000000 == 0) {
                    ...
                    LOG.info(String.format(
                            "... %d data points in %dms (%.1f points/s)",
        ...
        LOG.info(String.format("Processed %s in %d ms, %d data points"
                        + " (%.1f points/s)", path, time_delta, points,
    ...
    private static WritableDataPoints getDataPoints(final TSDB tsdb,
                                                    final String metric, final HashMap<String, String> tags) {
