...
final class PutDataPointRpc implements TelnetRpc {
	 ...
	 * 
	 * @param tsdb
	 *            The TSDB to import the data point into.
	 * @param words
	 ...
	 */
	private Deferred<Object> importDataPoint(final TSDB tsdb,
			final String[] words) {
		...
		if (Tags.looksLikeInteger(value)) {
			return tsdb
					.addPoint(metric, timestamp, Tags.parseLong(value), tags);
		} else { // floating point value
			return tsdb.addPoint(metric, timestamp, Float.parseFloat(value),
					tags);
		}
	}
}
