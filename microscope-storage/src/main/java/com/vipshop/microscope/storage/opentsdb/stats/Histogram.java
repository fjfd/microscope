...
public final class Histogram {
     ...
     * Constructor.
     *
     * @param max      The maximum value of the histogram. Any value greater than
     *                 this will be considered to be "infinity".
     * @param interval The interval (size) of each linear bucket.
     * @param cutoff   The value beyond which to switch to exponential buckets. The
     *                 histogram may actually use this value or a value up to
     *                 {@code interval} greater.
     * @throws IllegalArgumentException if any of following conditions are not met:
     *                                  <p/>
     *                                  <pre>
     *                                    0 &lt; interval &lt;= max
     *                                    0 &lt;= cutoff &lt;= max
