...
final class Span implements DataPoints {
     ...
     * @throws IllegalArgumentException if the argument and this span are for two different time
     *                                  series.
     * @throws IllegalArgumentException if the argument represents a row for data points that are
