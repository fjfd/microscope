...
final class TSDMain {
    ...
    public static void main(String[] args) {
        ...
        args = new String[]{"--table=tsdb", "--uidtable=tsdb-uid", "--port=9411", "--staticroot=./", "--cachedir=./", "--auto-metric=true", "--worker-threads=4", "--zkbasedir=/hbase", "--zkquorum=10.100.90.183", "--async-io=true"};
