...
public interface UniqueIdInterface {
     ...
     * @throws net.opentsdb.uid.NoSuchUniqueId if the given ID is not assigned.
     * @throws org.hbase.async.HBaseException  if there is a problem communicating with HBase.
     ...
     * @throws net.opentsdb.uid.NoSuchUniqueName if the name requested doesn't have an ID assigned.
     * @throws org.hbase.async.HBaseException    if there is a problem communicating with HBase.
