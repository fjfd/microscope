...
public final class UniqueId implements UniqueIdInterface {
   ...
   * terms.
   * @throws org.hbase.async.HBaseException if there was a problem getting suggestions from
   * HBase.
   */
   ...
   * @throws org.hbase.async.HBaseException if there was a problem with HBase while trying to
   * update the mapping.
   */
  public void rename(final String oldname, final String newname) {
    ...
    // Update cache.
    addIdToCache(newname, row);            // save     new name -> ID
   ...
   * @throws org.hbase.async.HBaseException if all the attempts have failed.  This exception
