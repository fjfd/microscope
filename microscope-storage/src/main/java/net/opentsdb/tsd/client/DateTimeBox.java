...
final class DateTimeBox extends DateBox {
  ...
  private static final class DateTimePicker extends DatePicker {
    ...
    /**
     * Sets the {@link net.opentsdb.tsd.client.DateTimeBox} this {@link net.opentsdb.tsd.client.DateTimeBox.DateTimePicker} belongs to.
    ...
    /**
     * Sets the date of the {@link DateBox} to the given {@link java.util.Date}.
     */
