...
final class TsdbQuery implements Query {
     ...
     *
     * @param spans The {@link net.opentsdb.core.Span}s found for this query ({@link #findSpans}).
    ...
    private long getScanStartTime() {
        ...
        // start_time = ... 12:31:00.  If we create the scanner to look
    ...
    private long getScanEndTime() {
        ...
        // problem we always save 1 second to the end_time.  Only when the end_time
     ...
     *
     * @param scanner The scanner on which to save the filter.
     */
