...
final class Span implements DataPoints {
   ...
   * @param row The compacted HBase row to save to this span.
  ...
  /** Iterator for {@link net.opentsdb.core.Span}s. */
   ...
   * {@link net.opentsdb.core.Span} have {@code O(1)} access to individual data points, in order
   * to be efficient.
   */
