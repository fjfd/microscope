 ...
 * {@link net.opentsdb.core.Span}s that are for the same time series but different tags
 ...
 * iterator when using the {@link net.opentsdb.core.Span.DownsamplingIterator}.
 */
final class SpanGroup implements DataPoints {
   ...
   * ignored.
   * @param spans A sequence of initial {@link Spans} to save to this group.
   ...
   * @param span The span to save to this group.  If none of the data points
  ...
  void add(final Span span) {
    if (tags != null) {
      throw new AssertionError("The set of tags has already been computed"
                               + ", you can't save more Spans to " + this);
    }
   ...
   * <p>
   * This where the real business of {@link net.opentsdb.core.SpanGroup} is.  This iterator
   * provides a merged, aggregated view of multiple {@link net.opentsdb.core.Span}s.  The data
  ...
  private final class SGIterator
    ...
    /**
     * Where we are in each {@link net.opentsdb.core.Span} in the group.
    ...
    /** Creates a new iterator for this {@link net.opentsdb.core.SpanGroup}. */
    SGIterator() {
